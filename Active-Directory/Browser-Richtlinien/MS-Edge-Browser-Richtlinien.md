...
- Wie der Microsoft Edge über GPO Richtlinie auf allen Clients `deinstalliert` oder in eine `Art "Kiosk-Modus"` versetzt werden kann, wird in der Anleitung [MS-Edge einschränken oder deinstallieren](https://github.com/replay45/Windows-Apple-und-Android/blob/main/Active-Directory/Browser-Richtlinien/MS-Edge-einschr%C3%A4nken-oder-deinstallieren-Active-Directoty.md) erklärt.
